...
triggerAlternate.addEventListener("click", function () {
	trigger('alternate', 'default');moveOverlay('right');
});

triggerDefault = document.getElementById('triggerDefault');
triggerDefault.addEventListener("click", function () {
	trigger('default', 'alternate');moveOverlay('left');
});
